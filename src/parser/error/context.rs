use crate::diagnostic::{ERR_CODE_CLASS_DEF_TRAILING_TOK, ERR_CODE_CLASS_END_TRAILING_TOK, ERR_CODE_INVALID_CLASS_FLAG, ERR_CODE_INVALID_METHOD_FLAG, ERR_CODE_METHOD_TRAILING_TOK, ERR_CODE_SUPER_TRAILING_TOK, ERR_CODE_TH_TRAILING_TOK, ERR_CODE_TOKEN_OUTSIDE_CLASS, ERR_CODE_UNEXPECTED_TOKEN_IN_CLASS, ERR_CODE_UNEXPECTED_TOKEN_IN_METHOD};
